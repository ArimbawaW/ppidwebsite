    ...
    <nav class="navbar navbar-expand-lg" style="background: linear-gradient(to right, #1a6b8a, #003344);">
        <div class="container-fluid">
            ...
            <a class="navbar-brand text-white fw-bold d-flex align-items-center" href="<?php echo e(route('home')); ?>">
                <img src="<?php echo e(asset('build/assets/LogoPKP.png')); ?>" alt="Logo PKP" height="40" class="me-2">
                <div>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <!-- Standar Layanan DROPDOWN DINAMIS -->
<li class="nav-item dropdown">
            ...
            <div class="row d-none d-md-flex align-items-start">
                ...
                <div class="col-md-4">
                    <div class="d-flex align-items-center">
                        <img src="<?php echo e(asset('build/assets/LogoPKP.png')); ?>" 
                             alt="Logo" 
...
</html><?php /**PATH C:\ppid-website\resources\views/layouts/app.blade.php ENDPATH**/ ?>