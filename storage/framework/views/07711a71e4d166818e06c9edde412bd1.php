...
<?php $__env->startSection('title', 'Standar Layanan - PPID'); ?>
...
<section class="py-5">
    <div class="container">
        ...
        <div class="row g-4">
            <?php $__empty_1 = true; $__currentLoopData = $standarLayanan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 shadow-sm border-0 hover-card">
                    ...
                    <div class="card-header text-white text-center py-4" 
                        ...
                        <div class="mb-2">
                            <i class="bi bi-<?php echo e($index % 3 == 0 ? 'clock' : ($index % 3 == 1 ? 'file-text' : 'check-circle')); ?> fs-1"></i>
                        </div>
                        <h5 class="mb-0 fw-bold"><?php echo e($item->judul); ?></h5>
                    </div>
                    
                    <div class="card-body">
                        <?php if($item->deskripsi): ?>
                        <p class="text-muted"><?php echo e($item->deskripsi); ?></p>
                        <?php endif; ?>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\ppid-website\resources\views/frontend/standar-layanan/index.blade.php ENDPATH**/ ?>