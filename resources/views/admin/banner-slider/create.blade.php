...
@section('title', 'Tambah Banner Slider - Admin PPID')
...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="fw-bold" style="color: #003f54;">
            <i class="bi bi-plus-circle me-2"></i>Tambah Banner Slider
        </h2>
            ...
            <form action="{{ route('admin.banner-slider.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <small class="text-info d-block mt-1">
                        ...
                        Gambar akan otomatis di-crop sesuai rasio yang disarankan
                    </small>
